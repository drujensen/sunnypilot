...
COMFORT_BRAKE = 2.5
STOP_DISTANCE = 4.5  # reduced from 6.0m; tighter stop gap in traffic and at lights
CRUISE_MIN_ACCEL = -1.2
CRUISE_MAX_ACCEL = 1.9  # raised from 1.6; closer to the 2.0 m/s^2 hardware ceiling
...
def get_T_FOLLOW(personality=log.LongitudinalPersonality.standard):
  if personality==log.LongitudinalPersonality.relaxed:
    return 1.45  # reduced from 1.75
  elif personality==log.LongitudinalPersonality.standard:
    return 1.20  # reduced from 1.45
  elif personality==log.LongitudinalPersonality.aggressive:
    return 1.00  # reduced from 1.25
  else:
    raise NotImplementedError("Longitudinal personality not supported")
